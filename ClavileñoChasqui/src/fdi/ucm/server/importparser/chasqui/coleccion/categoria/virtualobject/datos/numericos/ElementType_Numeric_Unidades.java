...
public class ElementType_Numeric_Unidades  implements InterfaceChasquiparser{
	...
	public ElementType_Numeric_Unidades(String name,
		...
		atributonumericounidad.getShows().add(Valor);
		atributonumericounidad.getShows().add(Valor2);
		atributonumericounidad.getShows().add(Valor3);
		...
		atributonumericounidad.getShows().add(MetaType);
